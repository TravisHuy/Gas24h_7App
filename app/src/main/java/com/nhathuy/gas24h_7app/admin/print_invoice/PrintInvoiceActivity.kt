...
import com.nhathuy.gas24h_7app.databinding.ActivityPrintInvoiceBinding
import javax.inject.Inject

class PrintInvoiceActivity : AppCompatActivity(),PrintInvoiceContract.View{

    private lateinit var binding:ActivityPrintInvoiceBinding
    private lateinit var adapter: PendingConfirmationAdapter
    private val selectedOrders = mutableSetOf<String>()
    @Inject
    lateinit var presenter: PrintInvoicePresenter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPrintInvoiceBinding.inflate(layoutInflater)
