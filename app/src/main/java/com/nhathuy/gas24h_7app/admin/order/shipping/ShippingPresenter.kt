...
class ShippingPresenter @Inject constructor(private val orderRepository: OrderRepository,
                                           private val productRepository: ProductRepository,
                                           private val userRepository: UserRepository): ShippingContract.Presenter
{
    ...
    override fun attachView(view: ShippingContract.View) {
        this.view = view
    }
