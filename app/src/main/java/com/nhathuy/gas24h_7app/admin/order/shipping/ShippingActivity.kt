...
import com.nhathuy.gas24h_7app.databinding.ActivityShippingBinding
import javax.inject.Inject

class ShippingActivity : AppCompatActivity(),ShippingContract.View {
    ...
    @Inject
    lateinit var presenter: ShippingPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter.loadOrders("PROCESSING")
    }
