...
class AddReviewTestPresenter @Inject constructor(private val reviewRepository: ReviewRepository,
                                                 private val userRepository: UserRepository,
                                                 private val productRepository: ProductRepository,
                                                 private val orderRepository: OrderRepository
):AddReviewTestContract.Presenter {

    private var view:AddReviewTestContract.View? = null
    ...
    override fun submitReview(rating: Float, comment: String) {
        ...
        coroutineScope.launch {
            try {
                ...
                val result = reviewRepository.createReviewTest(review,images,video)
                result.fold(
                    onSuccess = {
