        ...
        with(holder.binding){
            product?.let {
                ...
                orderProductPrice.text=if(it.offerPercentage>0){
                    NumberFormatUtils.formatPrice(it.getDiscountedPrice())
                }
                else{
                    NumberFormatUtils.formatPrice(it.price)
                }
                ...
                productTotalPrice.text=NumberFormatUtils.formatPrice(totalPrice)
