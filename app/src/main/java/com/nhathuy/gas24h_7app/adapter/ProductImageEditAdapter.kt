...
class ProductImageEditAdapter(private val images: MutableList<Uri>,
                              private val onDeleteClick: (Int) -> Unit,
                              private val onImageCountChanged: (Int) -> Unit
) : RecyclerView.Adapter<ProductImageEditAdapter.ImageViewHolder>() {
    ...
    fun addImage(uri: Uri){
        ...
        onImageCountChanged(images.size)
    }
